...
function FoodForm() {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100" style={{ backgroundColor: 'rgba(211,211,211,0.5)', padding: '10px' }}>
      <div style={{ maxWidth: '600px', width: '80%' }}>
        <div className="text-center" style={{ backgroundColor: 'grey', padding: '10px', borderRadius: '10px' }}>
          <h2>Donation</h2>
          <Form onSubmit={handleSubmit} className="mt-3">
            <Form.Group controlId="foodType" className="mb-2">
              <Form.Label><strong>Food Type</strong></Form.Label>
              <InputGroup className="border rounded">
                <InputGroup.Text><FaUtensils /></InputGroup.Text>
                <Form.Control
            ...
            <Form.Group controlId="timeCooked" className="mb-2">
              <Form.Label><strong>Time Cooked</strong></Form.Label>
              <InputGroup className="border rounded">
                <InputGroup.Text><FaClock /></InputGroup.Text>
                <Form.Control
            ...
            <Button type="submit" variant="dark" className="mt-2 btn-block btn-lg" style={{ width: '100%' }}>Add Item</Button>
          </Form>
          <Link to="/historys" className="btn btn-primary mt-2">View Donations</Link>
        </div>
      </div>
      <ToastContainer position="top-right" autoClose={5000} hideProgressBar={false} newestOnTop={false} closeOnClick rtl={false} pauseOnFocusLoss draggable pauseOnHover />
    </div>
